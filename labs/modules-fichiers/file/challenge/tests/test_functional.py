...
# Ce lab démontre que `state: touch` N'EST PAS idempotent (il réécrit le
# mtime à chaque passage) : c'est justement sa leçon, et son README le dit.
# Exiger changed=0 ici contredirait ce que le lab enseigne.
