...
🔗 [**Configuration Ansible : ansible.cfg, précédence, options critiques**](https://blog.stephane-robert.info/docs/infra-as-code/gestion-de-configuration/ansible/decouvrir/ansible-config-fichier/)
