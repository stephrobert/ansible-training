...
🔗 [**Argument specs Ansible : valider les entrées d'un rôle**](https://blog.stephane-robert.info/docs/infra-as-code/gestion-de-configuration/ansible/roles/argument-specs/)
