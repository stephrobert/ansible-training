...
Le challenge ([`challenge/README.md`](challenge/README.md)) demande de **reproduire le déploiement** sur `db1.lab`, mais en écrivant le rôle vous-même au lieu de réutiliser celui qu'on vous a fourni ici. Tests automatisés via `pytest+testinfra` :
