...
🔗 [**Dépendances entre rôles Ansible**](https://blog.stephane-robert.info/docs/infra-as-code/gestion-de-configuration/ansible/roles/dependencies/)
...
├── README.md
├── challenge/
│   └── solution.yml               ← à écrire : consomme uniquement webserver
└── roles/
    ├── webserver/
...
Écrivez un play minimal qui consomme uniquement le rôle `webserver`
(cf. challenge), puis :
