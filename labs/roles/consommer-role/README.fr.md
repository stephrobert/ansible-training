...
🔗 [**Consommer un rôle Ansible**](https://blog.stephane-robert.info/docs/infra-as-code/gestion-de-configuration/ansible/roles/consommer-role/)
...
├── README.md
├── roles/
│   └── webserver/        ← tasks/main.yml (déploiement) + tasks/stamp.yml (trace)
└── challenge/
    └── solution.yml      ← à écrire : les 3 formes, prouvées sur db1.lab
```
...
Écrivez un `lab.yml` reprenant les trois formes ci-dessus, puis lancez :
