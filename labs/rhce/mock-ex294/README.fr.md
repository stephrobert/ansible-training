...
- **`ansible-navigator`** : un vrai objectif de l'EX294 (utiliser le content navigator pour trouver des modules dans les collections et construire des inventaires). Tester en plus votre playbook dans `creator-ee` (lab 84) garantit la portabilité.
