...
- **`ANSIBLE_CALLBACKS_ENABLED=ansible.posix.profile_tasks`** sans toucher à
  `ansible.cfg`. Un callback s'active par son nom dans cette liste ; il n'existe
  pas de variable `ANSIBLE_PROFILE_TASKS`, et la poser ne produit aucun effet.
