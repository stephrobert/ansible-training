...
Voir [`challenge/README.md`](challenge/README.md) — produire un fichier d'inventaire des collections installées avec **leurs versions** et leur **path**, déposé sur `db1.lab`.
