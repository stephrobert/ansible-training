...
**mode 0644**. Ajouter `backup: true` est une **bonne pratique de
production**, recommandée mais **non vérifiée par les tests**.
...
>   écraser. Bonne pratique de production pour les configs critiques, **non
>   vérifiée par les tests** (au 1er run, rien à sauvegarder).
