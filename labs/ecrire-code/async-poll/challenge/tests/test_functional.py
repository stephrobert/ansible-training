...
# Ce lab lance une tâche asynchrone via `shell:`, non idempotent par nature
# (son README l'assume et impose `changed_when: true`). Exiger changed=0 ici
# contredirait ce que le lab enseigne.
