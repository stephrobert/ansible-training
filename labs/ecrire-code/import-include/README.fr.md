...
🔗 [**Import vs Include : les 5 directives Ansible**](https://blog.stephane-robert.info/docs/infra-as-code/gestion-de-configuration/ansible/ecrire-code/playbooks/import-include/)
...
Voir [`challenge/README.md`](challenge/README.md) : combiner `import_tasks` (statique) + `include_tasks` (avec loop) + une tâche séparée, en déposant les fichiers marqueurs qui prouvent l'exécution de chaque mécanisme.
